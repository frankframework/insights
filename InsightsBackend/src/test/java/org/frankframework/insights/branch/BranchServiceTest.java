...
public class BranchServiceTest {
	...
	@Mock private GitHubRepositoryStatisticsService gitHubRepositoryStatisticsService;
	...
	public void injectBranches_shouldSkip_whenCountsEqual() throws GitHubClientException {
		when(gitHubRepositoryStatisticsService.getGitHubRepositoryStatisticsDTO()).thenReturn(statsDTO);
	...
	@Test
	public void injectBranches_shouldInject_andFilterProtectedBranches() throws GitHubClientException, BranchInjectionException {
		when(gitHubRepositoryStatisticsService.getGitHubRepositoryStatisticsDTO()).thenReturn(statsDTO);
	...
	@Test
	public void injectBranches_shouldHandleEmptyOrNullBranchDTOSet() throws GitHubClientException, BranchInjectionException {
		when(gitHubRepositoryStatisticsService.getGitHubRepositoryStatisticsDTO()).thenReturn(statsDTO);
	...
	public void getBranchPullRequestsByBranches_shouldReturnMapForGivenBranches() {
		...
		when(branchPullRequestRepository.findAllByBranch_Id(protectedBranch.getId())).thenReturn(bprs);

		Map<String, Set<BranchPullRequest>> result = branchService.getBranchPullRequestsByBranches(List.of(protectedBranch));
		assertEquals(1, result.size());
	...
	public void getBranchPullRequestsByBranches_shouldReturnEmptyMapForEmptyBranchesList() {
		Map<String, Set<BranchPullRequest>> result = branchService.getBranchPullRequestsByBranches(Collections.emptyList());
		assertTrue(result.isEmpty());
	}
	...
	public void getBranchPullRequestsByBranchId_shouldReturnEmptySetIfNone() {
		when(branchPullRequestRepository.findAllByBranch_Id(protectedBranch.getId())).thenReturn(Collections.emptySet());
		Set<BranchPullRequest> result = branchService.getBranchPullRequestsByBranchId(protectedBranch.getId());
		assertTrue(result.isEmpty());
	}
