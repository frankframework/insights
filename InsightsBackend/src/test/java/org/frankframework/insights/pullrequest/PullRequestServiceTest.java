...
class PullRequestServiceTest {
	...
	@Mock private BranchPullRequestRepository branchPullRequestRepository;
	...
	public void setUp() {
		...
		masterPR = new PullRequestDTO(UUID.randomUUID().toString(), 1, "pr1", null, OffsetDateTime.now().minusDays(1), null, null, null);
		branchPR = new PullRequestDTO(UUID.randomUUID().toString(), 2, "pr2", null, OffsetDateTime.now(), null, null, null);
		...
		pullRequestService = new PullRequestService(
				gitHubClient, mapper, branchPullRequestRepository, branchService, labelService, milestoneService, issueService, gitHubProperties);
	}

	@Test
	public void injectBranchPullRequests_shouldUpdateBranchWithMergedPRs() throws PullRequestInjectionException, GitHubClientException, MappingException {
		...
		when(branchPullRequestRepository.findBranchPullRequestByBranchId(testBranch.getId())).thenReturn(Collections.emptySet());
	...
	@Test
	public void injectBranchPullRequests_shouldHandleEmptyMasterPRs() throws PullRequestInjectionException, GitHubClientException, MappingException {
		when(branchService.getAllBranches()).thenReturn(List.of(testBranch));
	...
	@Test
	public void injectBranchPullRequests_shouldSkipBranchOnException() throws PullRequestInjectionException, GitHubClientException {
		...
		when(gitHubClient.getBranchPullRequests(testBranch.getName())).thenThrow(new GitHubClientException("GitHub client error", null));
	...
	@Test
	public void injectBranchPullRequests_shouldIncludeRelevantMasterPRs() throws PullRequestInjectionException, MappingException, GitHubClientException {
		PullRequestDTO earlyMasterPR = new PullRequestDTO(null, 0, "pr0", null, OffsetDateTime.now().minusDays(2), null, null, null);
		when(branchService.getAllBranches()).thenReturn(List.of(testBranch));
	...
	@Test
	public void injectBranchPullRequests_shouldHandleNullMergedAtDates() throws PullRequestInjectionException, GitHubClientException, MappingException {
	...
	@Test
	public void injectBranchPullRequests_shouldAvoidDuplicatePRs() throws PullRequestInjectionException, GitHubClientException, MappingException {
