...
public class MilestoneControllerTest {
    ...
    public void getAllOpenMilestones_returnsMilestones() throws Exception {
        MilestoneResponse m1 = new MilestoneResponse("id1", 1, "v1.0", "https//example.com", GitHubPropertyState.OPEN, null, 0, 0);
        MilestoneResponse m2 = new MilestoneResponse("id2", 2, "v2.0", "https//example.com", GitHubPropertyState.OPEN, null, 0, 0);
