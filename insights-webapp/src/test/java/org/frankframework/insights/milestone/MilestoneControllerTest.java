...
public class MilestoneControllerTest {
    ...
    public static class MockConfig {
        @Bean
        public MilestoneQueryService milestoneQueryService() {
            return mock(MilestoneQueryService.class);
        }
    }

    @BeforeEach
    public void resetMocks() {
        reset(milestoneQueryService);
    }
    ...
    public void getAllMilestones_returnsMilestones() throws Exception {
        ...
        when(milestoneQueryService.getAllMilestones()).thenReturn(milestones);
    ...
    public void getAllMilestones_returnsEmptySet() throws Exception {
        when(milestoneQueryService.getAllMilestones()).thenReturn(Collections.emptySet());
    ...
    public void getAllMilestones_serviceReturnsNull_treatedAsEmptySet() throws Exception {
        when(milestoneQueryService.getAllMilestones()).thenReturn(null);
    ...
    public void getAllMilestones_serviceThrowsMappingException_returns400() throws Exception {
        when(milestoneQueryService.getAllMilestones()).thenThrow(new MappingException("fail", null));
