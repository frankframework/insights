...
public class ReleaseControllerTest {
    ...
    public static class TestConfig {
        @Bean
        public ReleaseQueryService releaseQueryService() {
            return mock(ReleaseQueryService.class);
        }
    }

    @BeforeEach
    public void resetMocks() {
        reset(releaseQueryService);
    }
    ...
    public void getAllReleases_returnsOkWithReleases() throws Exception {
        ...
        when(releaseQueryService.getAllReleases()).thenReturn(releases);
    ...
    public void getAllReleases_returnsEmptySet() throws Exception {
        when(releaseQueryService.getAllReleases()).thenReturn(Collections.emptySet());
    ...
    public void getAllReleases_serviceReturnsNull_treatedAsEmptySet() throws Exception {
        when(releaseQueryService.getAllReleases()).thenReturn(null);
    ...
    public void getReleaseByReleaseId_returnsOk() throws Exception {
        ...
        ReleaseResponse response =
                new ReleaseResponse("id1", "tag1", "name1", OffsetDateTime.now(), OffsetDateTime.now(), branchResponse);
        when(releaseQueryService.getReleaseById("rel1")).thenReturn(response);
    ...
    public void getIssuesByReleaseId_throwsReleaseNotFoundException_returns404() throws Exception {
        when(releaseQueryService.getReleaseById("relX")).thenThrow(new ReleaseNotFoundException("Not found", null));
