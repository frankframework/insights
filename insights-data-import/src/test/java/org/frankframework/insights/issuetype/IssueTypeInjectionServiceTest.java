...
public class IssueTypeInjectionServiceTest {
    ...
    void injectIssueTypes_shouldSkipIfCountsEqual() throws Exception {
        ...
        issueTypeInjectionService.injectIssueTypes();
    ...
    void injectIssueTypes_shouldThrowOnException() throws Exception {
        ...
        assertThrows(IssueTypeInjectionException.class, () -> issueTypeInjectionService.injectIssueTypes());
    }

    @Test
    void getAllIssueTypesMap_shouldReturnCorrectMap() {
        when(issueTypeRepository.findAll()).thenReturn(List.of(type1, type2));
        Map<String, IssueType> result = issueTypeInjectionService.getAllIssueTypesMap();
