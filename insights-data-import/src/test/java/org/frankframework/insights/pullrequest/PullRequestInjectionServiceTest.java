...
public class PullRequestInjectionServiceTest {
    ...
    public void setUp() {
        ...
        pullRequestInjectionService = new PullRequestInjectionService(
                gitHubGraphQLClient,
                mapper,
    ...
    public void injectBranchPullRequests_shouldUpdateBranchWithMergedPRs()
        ...
        when(branchInjectionService.getAllBranches()).thenReturn(List.of(testBranch));
        ...
        when(labelInjectionService.getAllLabelsMap()).thenReturn(Map.of());
        when(issueInjectionService.getAllIssuesMap()).thenReturn(Map.of());

        pullRequestInjectionService.injectBranchPullRequests();
    ...
    public void injectBranchPullRequests_shouldThrowNothingIfGetPullRequestsFails()
        ...
        assertDoesNotThrow(() -> pullRequestInjectionService.injectBranchPullRequests());
    }
    ...
    public void injectBranchPullRequests_shouldSkipBranchOnException() throws GitHubGraphQLClientException {
        ...
        when(branchInjectionService.getAllBranches()).thenReturn(List.of(testBranch, masterBranch));
    ...
    public void injectBranchPullRequests_shouldSkipWhenNoPullRequests()
        ...
        when(branchInjectionService.getAllBranches()).thenReturn(List.of(emptyBranch));
    ...
    public void injectBranchPullRequests_shouldHandleNullPRsAndSkip()
        ...
        when(branchInjectionService.getAllBranches()).thenReturn(List.of(branch));
    ...
    public void injectBranchPullRequests_shouldSaveLabelsAndIssues()
        ...
        when(issueInjectionService.getAllIssuesMap()).thenReturn(issueMap);
    ...
    public void injectBranchPullRequests_shouldProcessBranchEvenIfExceptionInOne()
        ...
        when(branchInjectionService.getAllBranches()).thenReturn(List.of(b1, b2));
    ...
    public void injectBranchPullRequests_shouldThrowPullRequestInjectionException_whenMasterPullRequestFails()
        ...
        PullRequestInjectionException exception = assertThrows(
                PullRequestInjectionException.class, () -> pullRequestInjectionService.injectBranchPullRequests());
    ...
    public void
        ...
        PullRequestDTO prFromNewName =
                new PullRequestDTO("id-new", 100, "new PR", null, OffsetDateTime.now(), null, null, null);
        ...
        when(branchInjectionService.getAllBranches()).thenReturn(List.of(releaseBranch));
    ...
    public void fetchCombinedPullRequestsForBranch_shouldOnlyFetchCurrentName_whenBranchDoesNotMatchPattern()
        ...
        PullRequestDTO prFromFeature =
                new PullRequestDTO("id-feature", 200, "feature PR", null, OffsetDateTime.now(), null, null, null);

        PullRequest prEntity = new PullRequest();
        prEntity.setId("id-feature");
        prEntity.setTitle("feature PR");

        when(branchInjectionService.getAllBranches()).thenReturn(List.of(featureBranch));
        when(gitHubGraphQLClient.getBranchPullRequests("master")).thenReturn(Set.of());
    ...
    public void fetchCombinedPullRequestsForBranch_shouldDeduplicatePullRequests_whenSamePRExistsInBothNames()
        ...
        PullRequestDTO duplicatePR =
                new PullRequestDTO("id-dup", 300, "duplicate PR", null, OffsetDateTime.now(), null, null, null);
    ...
    public void fetchCombinedPullRequestsForBranch_shouldHandleEmptyHistoricalPullRequests()
        ...
        PullRequestDTO prFromNewName =
                new PullRequestDTO("id-new", 400, "new PR only", null, OffsetDateTime.now(), null, null, null);
    ...
    public void injectBranchPullRequests_shouldAssignMilestonesToPullRequests()
        ...
        MilestoneDTO milestoneDTO = new MilestoneDTO("m1", 1, null, null, null, null, 0, 0);
        PullRequestDTO prDto = new PullRequestDTO(
        ...
        when(branchPullRequestRepository.findAllByBranch_Id(branch.getId())).thenReturn(Collections.emptySet());
        when(pullRequestRepository.saveAll(anySet())).thenReturn(List.of(prEntity));
        when(milestoneInjectionService.getAllMilestonesMap()).thenReturn(Map.of("m1", milestone));
        when(labelInjectionService.getAllLabelsMap()).thenReturn(Map.of());
        when(issueInjectionService.getAllIssuesMap()).thenReturn(Map.of());

        pullRequestInjectionService.injectBranchPullRequests();

        verify(milestoneInjectionService, atLeastOnce()).getAllMilestonesMap();
        verify(pullRequestRepository, times(1)).saveAll(anySet());
    }
    ...
    public void injectBranchPullRequests_shouldHandleNullMilestone()
        ...
        PullRequestDTO prDto =
                new PullRequestDTO("id-nm", 700, "pr without milestone", null, OffsetDateTime.now(), null, null, null);
        ...
        when(branchPullRequestRepository.findAllByBranch_Id(branch.getId())).thenReturn(Collections.emptySet());
        when(pullRequestRepository.saveAll(anySet())).thenReturn(List.of(prEntity));
        when(milestoneInjectionService.getAllMilestonesMap()).thenReturn(Map.of());
        when(labelInjectionService.getAllLabelsMap()).thenReturn(Map.of());
        when(issueInjectionService.getAllIssuesMap()).thenReturn(Map.of());
