...
public class IssueProjectItemsInjectionServiceTest {
    ...
    public void setup() {
        ...
        issueProjectItemsInjectionService = new IssueProjectItemsInjectionService(
    ...
    public void injectIssueProjectItems_shouldWrapGitHubClientException() throws GitHubGraphQLClientException {
        ...
        IssueProjectItemInjectionException ex = assertThrows(
                IssueProjectItemInjectionException.class,
                () -> issueProjectItemsInjectionService.injectIssueProjectItems());
    ...
    public void getAllIssuePrioritiesMap_shouldReturnCorrectMap() {
        ...
        Map<String, IssuePriority> result = issueProjectItemsInjectionService.getAllIssuePrioritiesMap();
    ...
    public void getAllIssueStatesMap_shouldReturnCorrectMap() {
        ...
        Map<String, IssueState> result = issueProjectItemsInjectionService.getAllIssueStatesMap();
        assertEquals(2, result.size());
