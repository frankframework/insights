...
MERGE INTO release (id, tag_name, name, published_at, branch_id) KEY(id) VALUES
	...
	('RE_kwDOAIg5ds4J18zh','v8.2.0','v8.2.0', DATEADD('MONTH', -8, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMi1yZWxlYXNl'),
	('RE_kwDOAIg5ds4KrJui','v8.2.1','v8.2.1', DATEADD('MONTH', -6, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMi1yZWxlYXNl'),
	('RE_kwDOAIg5ds4Ks6Gh','v8.3.0','v8.3.0', DATEADD('MONTH', -6, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMy1yZWxlYXNl'),
