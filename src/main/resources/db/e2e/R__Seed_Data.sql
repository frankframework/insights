...
MERGE INTO release (id, tag_name, name, published_at, branch_id) KEY(id) VALUES
	...
	('RE_kwDOAIg5ds4Lhg3o','v9.0.0','v9.0.0', DATEADD('MONTH', -4, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzL2hlYWRzL3JlbGVhc2UvOS4w'),
	('RE_kwDOAIg5ds4MnUo_','v9.0.1','v9.0.1', DATEADD('MONTH', -3, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzL2hlYWRzL3JlbGVhc2UvOS4w'),
	('RE_kwDOAIg5ds4LkXe7','release/9.0-nightly','v9.0.2-nightly', DATEADD('MONTH', -1, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzL2hlYWRzL3JlbGVhc2UvOS4w'),
	...
	('RE_kwDOAIg5ds4KLQbP','v8.0.3','v8.0.3', DATEADD('MONTH', -11, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMC1yZWxlYXNl'),
	...
	('RE_kwDOAIg5ds4JWcoo','v8.1.0','v8.1.0', DATEADD('MONTH', -9, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMS1yZWxlYXNl'),
	('RE_kwDOAIg5ds4KrJiA','v8.1.2','v8.1.2', DATEADD('MONTH', -8, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMS1yZWxlYXNl'),
	('RE_kwDOAIg5ds4J18zh','v8.2.0','v8.2.0', DATEADD('MONTH', -7, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMi1yZWxlYXNl'),
	('RE_kwDOAIg5ds4KrJui','v8.2.1','v8.2.1', DATEADD('MONTH', -6, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMi1yZWxlYXNl'),
	('RE_kwDOAIg5ds4Ks6Gh','v8.3.0','v8.3.0', DATEADD('MONTH', -5, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMy1yZWxlYXNl'),
	('RE_kwDOAIg5ds4Ky4-S','release/8.3-nightly','v8.3.3-nightly', DATEADD('MONTH', -4, CURRENT_TIMESTAMP()),'MDM6UmVmODkyNzYwNjpyZWZzL2hlYWRzLzguMy1yZWxlYXNl'),
