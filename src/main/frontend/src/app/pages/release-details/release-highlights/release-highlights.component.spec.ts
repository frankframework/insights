...
const mockIssues: Issue[] = [
  {
    ...
    url: '',
    issueType: { id: 'id-1', name: 'Bug', color: 'red', description: 'description-1' },
  },
  {
    id: 'i2',
    number: 2,
    ...
    state: GitHubStates.OPEN,
    url: '',
    issueType: { id: 'id-2', name: 'Feature', color: 'blue', description: 'description-2' },
  },
  {
    id: 'i3',
    number: 3,
    ...
    state: GitHubStates.OPEN,
    url: '',
    issueType: { id: 'id-3', name: 'Bug', color: 'red', description: 'description-3' },
  },
...
describe('ReleaseHighlightsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [ColorService, provideHttpClient(withXhr()), provideHttpClientTesting()],
    }).compileComponents();
