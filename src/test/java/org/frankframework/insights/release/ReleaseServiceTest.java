...
public class ReleaseServiceTest {
    ...
    public void setUp() {
        ...
        dto1 = new ReleaseDTO("id1", "v1.0", "v1.0",
                new ReleaseTagCommitDTO(OffsetDateTime.now().minusDays(10)));
        dto2 = new ReleaseDTO("id2", "v1.1", "v1.1",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));

        dtoMalformed = new ReleaseDTO("id3", "foo_bar", "foo_bar",
    ...
    public void fallbackToMasterBranch_whenNoVersionBranchMatches() throws Exception {
        ReleaseDTO dto = new ReleaseDTO("id", "v9.9", "v9.9",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
    ...
    public void nullBranch_ifNoMatchAndNoMaster() throws Exception {
        ReleaseDTO dto = new ReleaseDTO("id", "v999.999", "v999.9990",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
    ...
    public void handlesNullBranchNameGracefully() throws Exception {
        ...
        ReleaseDTO dto = new ReleaseDTO("id", "vX.Y", "vX.Y",
                new ReleaseTagCommitDTO(relWithNull.getPublishedAt()));
    ...
    public void extractMajorMinor_variousCases() throws Exception {
        ReleaseDTO tagGood = new ReleaseDTO("id", "v3.5", "v3.5",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
        ...
        ReleaseDTO tagBad = new ReleaseDTO("id", "vX.Y", "vX.Y",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
    ...
    public void injectReleases_shouldAssignPRsToCorrectReleases_whenPRsFallInTimeWindows() throws Exception {
        // Arrange
        ReleaseDTO dto1 = new ReleaseDTO("id1", "v1.0", "v1.0",
                new ReleaseTagCommitDTO(OffsetDateTime.parse("2025-08-01T10:00:00Z")));
        ReleaseDTO dto2 = new ReleaseDTO("id2", "v1.1", "v1.1",
                new ReleaseTagCommitDTO(OffsetDateTime.parse("2025-08-10T10:00:00Z")));
        ReleaseDTO dto3 = new ReleaseDTO("id3", "v1.2", "v1.2",
                new ReleaseTagCommitDTO(OffsetDateTime.parse("2025-08-20T10:00:00Z")));
    ...
    public void isValidRelease_shouldFilterOutReleaseCandidate() throws Exception {
        ReleaseDTO rcRelease = new ReleaseDTO("id1", "v8.1.0-RC1", "v8.1.0-RC1",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
        ReleaseDTO validRelease = new ReleaseDTO("id2", "v8.1.0", "v8.1.0",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
    ...
    public void isValidRelease_shouldFilterOutBetaRelease() throws Exception {
        ReleaseDTO betaRelease = new ReleaseDTO("id1", "v7.0-B2", "v7.0-B2",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
        ReleaseDTO validRelease = new ReleaseDTO("id2", "v7.0.0", "v7.0.0",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
    ...
    public void isValidRelease_shouldFilterOutMultipleInvalidReleases() throws Exception {
        ReleaseDTO rc1 = new ReleaseDTO("id1", "v7.8-RC1", "v7.8-RC1",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
        ReleaseDTO rc2 = new ReleaseDTO("id2", "v7.8-RC2", "v7.8-RC2",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
        ReleaseDTO beta = new ReleaseDTO("id3", "v7.0-B3", "v7.0-B3",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
        ReleaseDTO validRelease = new ReleaseDTO("id4", "v7.8.0", "v7.8.0",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
    ...
    public void isValidRelease_shouldHandleNullReleaseName() throws Exception {
        ReleaseDTO nullNameRelease = new ReleaseDTO("id1", null, null,
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
    ...
    public void isValidRelease_shouldAllowCaseInsensitiveMatching() throws Exception {
        ReleaseDTO rcLowercase = new ReleaseDTO("id1", "v7.5-rc2", "v7.5-rc2",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
        ReleaseDTO betaUppercase = new ReleaseDTO("id2", "v7.6-B1", "v7.6-B1",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
        ReleaseDTO validRelease = new ReleaseDTO("id3", "v7.6.0", "v7.6.0",
                new ReleaseTagCommitDTO(OffsetDateTime.now()));
