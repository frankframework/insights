...
public class ReleaseControllerTest {
    ...
    public void getAllReleases_returnsOkWithReleases() throws Exception {
        ...
        ReleaseResponse response1 =
                new ReleaseResponse("id1", "tag1", "name1", OffsetDateTime.now(), OffsetDateTime.now(), "sha1", branchResponse);
        ReleaseResponse response2 =
                new ReleaseResponse("id2", "tag2", "name2", OffsetDateTime.now().minusDays(1), OffsetDateTime.now(),"sha2", branchResponse);
